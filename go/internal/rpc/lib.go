...
func Listen(ctx context.Context, addr string) (net.Listener, error) {
	...
	if err != nil {
		...
		if err != nil {
			return nil, terror.Errorf(ctx, "listen: %w", err)
		}
		return lis, nil
	}
	...
	if err != nil {
		return nil, terror.Errorf(ctx, "gostream listen: %w", err)
	}

	return lis, nil
}

func Client(ctx context.Context, target string) (pb.SrvClient, error) {
